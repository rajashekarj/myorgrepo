	...
	***************************/
	...
	$.fn.jqTransCheckBox = function(){
		return this.each(function(){
			...
			var oLabel = $('#' + this.id + '-label');
			$input.addClass('jqTransformHidden').wrap('<span class="jqTransformCheckboxWrapper"></span>');
			var $wrapper = $input.parent();
			var aLink = $('<a href="#" class="jqTransformCheckbox" id="'+ this.name + '-check' + '" ></a>');
	...
	$.fn.jqTransRadio = function(){
		return this.each(function(){
			...
			oLabel = $('#' + this.id + '-label');
			$input.addClass('jqTransformHidden').wrap('<span class="jqTransformRadioWrapper"></span>');
			var $wrapper = $input.parent();
			var aLink = $('<a href="#" class="jqTransformRadio" rel="'+ this.name +'" id="'+ this.id +'-q-'+ this.name + '-radio' +'"></a>');
			$wrapper.prepend(aLink);
			// Click Handler
			aLink.each(function(){
