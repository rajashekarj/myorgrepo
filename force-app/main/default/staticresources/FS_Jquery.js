...
/*  $(function(){
        ...
        { 
            ...
            //var cusCop14id1 = $($("[id$=fieldValue_lkid]"),ctx).val();
            //var cusCop14id2 = $($("[id$=fieldValue_lkold]"),ctx).val();
            ...
            //  var cusCop14id6 = $($("[id$=fieldValue_mod]"),ctx).val();
               ...
               // Strt
                   ...
                   $('.ssreqCls32 :selected').each(function(i, selectedElement) {
               ...
               //End
                //var cusCop32 = $('.ssreqCls32', ctx)[1].html();
                //var?cusCop32 =?$('.ssreqCls32 > option', ctx).clone(); 
                //var cusCop32 = $('.ssreqCls32:selected', ctx).clone();
                ...
                $("input.rowSSReqSelectBox:checkbox:checked").each(function(){
                    ...
                    //$($("[id$=fieldValue_lkid]"),ptx).val(cusCop14id1);
                    //$($("[id$=fieldValue_lkold]"),ptx).val(cusCop14id2);
                  ...
                  // $(this).closest('tr').find('.ssreqCls32').append(cusCop32);
                  
                  for (var j = 0; j < hexvalues.length; j++)
                    $(this).closest('tr').find('.ssreqCls32').append(new Option(hexvalues[j], hexvalues[j]));
       ...
       function FinanceCopy() {
		  ...
		  $(function(){
			...
			debugger;
                ...
                var ctx;
                ctx = $(this).closest('td');
                $('.InsCls10', ctx).show();$('.ssreqCls14', ctx).show();$('.InsCls13', ctx).show();$('.iwCls10', ctx).show();$('.iwCls13', ctx).show();$('.prodCls6', ctx).show();$('.prodCls10', ctx).show();$('.trnCls5', ctx).show();
                $('.assreqCls14', ctx).hide();$('.aInsCls10', ctx).hide();$('.aInsCls13', ctx).hide();$('.aiwCls10', ctx).hide();$('.aiwCls13', ctx).hide();$('.aprodCls6', ctx).hide();$('.aprodCls10', ctx).hide();$('.atrnCls5', ctx).hide();
                $('.editCont', ctx).hide();
            }); 
        });
        $(function(){
        ...
        $(function(){
            $('.atmCont').click(function(e){
                e.preventDefault();
                $('.salesUser').show(); $('.asalesUser').hide(); $('.atmCont').hide();
            }); 
        }); 
        $(function(){
            $('.atm2Cont').click(function(e){
                e.preventDefault();
                $('.comUser').show(); $('.acomUser').hide(); $('.atm2Cont').hide();
            }); 
        });  
        $(function(){
            $('.atm3Cont').click(function(e){
                e.preventDefault();
                $('.fpsUser').show(); $('.afpsUser').hide(); $('.atm3Cont').hide();
            }); 
        }); 
		function checkValue(){
        debbugger;
            ...
            if (history.pushState) {
                var newurl = window.location.protocol + "//" + window.location.host + window.location.pathname + '?id={!currentCIFId}&tab={!currentStage}';                
                ...
                $("tr.dataRow").each(function() {
                    ...
                    $('td.zxcv', this).each(function(){
                        ...
                        if(quantity1 != null && quantity1 != '' && quantity1a != ''){
                          $(this).find(".ssreqCls14").hide();$(this).find(".InsCls10").hide();$(this).find(".iwCls10").hide();$(this).find(".prodCls6").hide();$(this).find(".trnCls5").hide();
                          $(this).find(".assreqCls14").show();$(this).find(".aInsCls10").show();$(this).find(".aiwCls10").show();$(this).find(".aprodCls6").show();$(this).find(".atrnCls5").show();
                          $(this).find(".editCont").show();
                        }else if((quantity1 == '' && quantity1a == '') || (quantity1 != '' && quantity1a == '')){
                          $(this).find(".ssreqCls14").show();$(this).find(".InsCls10").show();$(this).find(".iwCls10").show();$(this).find(".prodCls6").show();$(this).find(".trnCls5").show();
                          $(this).find(".assreqCls14").hide();$(this).find(".aInsCls10").hide();$(this).find(".aiwCls10").hide();$(this).find(".aprodCls6").hide();$(this).find(".atrnCls5").hide();
